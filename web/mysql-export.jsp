...
<head>
    ...
    <meta charset="utf8">
    <style>
        body,td,th {  font-family: "宋体";  font-size: 12px;  padding: 2px 5px 2px 5px;  }
...
<%
    while (resultSet.next()) {
        ...
        <table border="1" cellspacing="0" cellpadding="0" align="center">
            <caption><%=resultSet.getString("table_name")%>：<%=resultSet.getString("table_comment")%></caption>
            <tbody>
            <tr>
                <th>字段名</th>
                <th>Key</th>
            ...
            <%
                ...
                while (table.next()){
                    %>
                    <tr>
                        <td class="c1"><%=table.getString(1)%></td>
                        <td class="c2"><%=table.getString(5)%></td>
                        <td class="c2"><%=table.getString(2)%></td>
                        <td class="c3"><%=table.getString(6)%></td>
                        <td class="c4"><%=table.getString(4)%></td>
                        <td class="c5"><%=table.getString(7)%></td>
                        <td class="c6"><%=table.getString(8)%></td>
                        <td class="c6"><%=table.getString(9)%></td>
                    </tr>
                    <%
                }
                table.close();s.close();
